...
public class NumbersEx {
	...
	// NOTE: THERE ARE OTHER WAYS TO SOLVE THE QUESTIONS, THIS IS ONE APPROACH YOU CAN TAKE.

	// Question 1 - Create a method that takes a number 10-99, and adds the two digits together
	...
	// NOTE: THE FOLLOWING CODE CAN BE FURTHER OPTIMISED(SHORTENED) - THINK ABOUT HOW IT COULD BE DONE AND TRY IT OUT

	// Question 2 (& 3 & 4) - Create a second method that when given the number 1-99 returns a String representation of this number
	public String stringRep(int number) {
		...
		if (number < 10) {
			...
			unit = units[countU];
			out = ten + " " + unit;
			// Question 3 - Expand on the method you wrote in Numbers 2 to allow the input 1-999
			...
			// Question 4 - Expand the method you wrote in Numbers 2 to allow the input 1-9999
	...
	// Numbers Revisited Q1 - Use a for()-loop to print the numbers 1-100 in words
